...
import { CARRIER_LIST, OFFNET_VENDOR_NAME_LIST } from '../../../@core/constants';
...
export class TrackerMappingComponent implements OnInit {
  ...
  readonly OFFNET_VENDOR_NAME_LIST = OFFNET_VENDOR_NAME_LIST;
  fields: { label: string; key: string; value?: string; required?: boolean; isInput?: boolean }[] = [
    ...
    { label: 'OFFNET Vendor Name', key: 'offnet_vendor_name', required: true },
